...
class MuPoTs(torch.utils.data.Dataset):
    def __init__(self):
        ...
        self.img_dir = osp.join('putting your path/mupots-3d-eval', 'MultiPersonTestSet')
        self.test_annot_path = osp.join('putting your path/mupots-3d-eval', 'MuPoTS-3D.json')
    ...
    def load_data(self):
        ...
        for aid in db.anns.keys():
            ...
            joint_img = transform_joint_to_other_db(joint_img, self.mupots_joints_name, self.coco_joints_name)  # self.coco_joints_name
...
class PoseMatcher:
    def __init__(self, dataloader):
        ...
        result_path = 'putting your path/3DCrowdNet_RELEASE/hhr_json'  # '/home/redarknight/projects/HHRNet'
...
def filter_bbox(output_list):
    ...
    for out in output_list:
        ...
        for idx in range(len(candidates)):
            ...
            #print(len(valid_gtpose_joints))
            #print(len(valid_pred_joints))
